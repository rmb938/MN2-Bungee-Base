...
public abstract class HelpTopic {
    ...
    /**
     * Determines if a {@link net.md_5.bungee.api.connection.ProxiedPlayer} is allowed to see this help topic.
     * <p>
     ...
     * HelpTopic#canSee(net.md_5.bungee.api.CommandSender)} function.
     *
